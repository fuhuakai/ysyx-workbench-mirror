...
void Vrv32___024root__trace_chg_sub_0(Vrv32___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgIData(oldp+133,(((0x400000U & vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg[2U])
                                   ? 0xbU : vlSelf->rv32__DOT__exu_inst__DOT__generic_csr_wdata)),32);
        bufp->chgIData(oldp+134,(vlSelf->rv32__DOT__exu_inst__DOT__generic_csr_wdata),32);
        ...
        bufp->chgCData(oldp+225,((0x7fU & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                                   >> 0x19U)))),7);
        bufp->chgBit(oldp+226,((1U & ((~ (IData)(vlSelf->rv32__DOT__idu_inst__DOT__post_valid_reg)) 
                                      & (~ (IData)(vlSelf->rv32__DOT__w_wbu_cycle_end))))));
        bufp->chgWData(oldp+227,(vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg),111);
        bufp->chgIData(oldp+231,(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_inst),32);
        bufp->chgQData(oldp+232,(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg),64);
        bufp->chgBit(oldp+234,((IData)((0U != (0xc00000U 
                                               & vlSelf->rv32__DOT__exu_inst__DOT__exu_valid_data_reg[3U])))));
        bufp->chgIData(oldp+235,(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata),32);
        bufp->chgCData(oldp+236,(vlSelf->rv32__DOT__lsu_inst__DOT__wmask),8);
        bufp->chgBit(oldp+237,(((~ (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__post_valid_reg)) 
                                & (IData)(vlSelf->rv32__DOT__exu_inst__DOT__post_valid_reg))));
        bufp->chgWData(oldp+238,(vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg),217);
        bufp->chgIData(oldp+245,(vlSelf->rv32__DOT__lsu_inst__DOT__unnamedblk1__DOT__raw_read_data),32);
