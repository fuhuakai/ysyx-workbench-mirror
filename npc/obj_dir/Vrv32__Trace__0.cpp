...
void Vrv32___024root__trace_chg_sub_0(Vrv32___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+19,(vlSelf->rv32__DOT__Inst_type),3);
        ...
        bufp->chgBit(oldp+25,(vlSelf->rv32__DOT__pc_sel_1));
        bufp->chgBit(oldp+26,(vlSelf->rv32__DOT__pc_sel_2));
        bufp->chgBit(oldp+27,(vlSelf->rv32__DOT__alu_sel_2));
        bufp->chgBit(oldp+28,(vlSelf->rv32__DOT__alu_sel_1));
        bufp->chgCData(oldp+29,(vlSelf->rv32__DOT__wb_sel),2);
        ...
        __Vtemp_ha9a73541__0[4U] = (((IData)(4U) + vlSelf->rv32__DOT__pc) 
                                    >> 0x1aU);
        bufp->chgWData(oldp+91,(__Vtemp_ha9a73541__0),136);
