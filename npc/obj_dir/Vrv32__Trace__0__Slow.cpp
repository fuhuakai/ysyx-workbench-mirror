...
VL_ATTR_COLD void Vrv32___024root__trace_full_sub_0(Vrv32___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+20,(vlSelf->rv32__DOT__IType),3);
    ...
    bufp->fullBit(oldp+26,(vlSelf->rv32__DOT__m1));
    bufp->fullBit(oldp+27,(vlSelf->rv32__DOT__m2));
    bufp->fullBit(oldp+28,(vlSelf->rv32__DOT__m3));
    bufp->fullBit(oldp+29,(vlSelf->rv32__DOT__m4));
    bufp->fullCData(oldp+30,(vlSelf->rv32__DOT__m5),2);
    ...
    __Vtemp_hcf9f527e__0[4U] = (((IData)(4U) + vlSelf->rv32__DOT__pc) 
                                >> 0x1aU);
    bufp->fullWData(oldp+92,(__Vtemp_hcf9f527e__0),136);
