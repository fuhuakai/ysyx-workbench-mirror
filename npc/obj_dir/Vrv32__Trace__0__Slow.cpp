...
VL_ATTR_COLD void Vrv32___024root__trace_init_sub__TOP__0(Vrv32___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+285,"temp", false,-1, 31,0);
    tracep->declBus(c+86,"npc_reg", false,-1, 31,0);
    tracep->pushNamePrefix("mux1 ");
    tracep->declBus(c+286,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+287,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+288,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+287,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+288,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+289,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+91,"out", false,-1, 31,0);
    tracep->declBus(c+71,"key", false,-1, 0,0);
    tracep->declBus(c+290,"default_out", false,-1, 31,0);
    tracep->declArray(c+94,"lut", false,-1, 65,0);
    tracep->declBus(c+291,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 2; ++i) {
    ...
    tracep->declBus(c+286,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+288,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+235,"lsu_rd", false,-1, 31,0);
    ...
    tracep->declBus(c+236,"dmem_rdata_t_reg", false,-1, 31,0);
    tracep->declBus(c+237,"dmem_rdata", false,-1, 31,0);
    tracep->declBus(c+238,"dmem_func3_reg", false,-1, 2,0);
    tracep->declBit(c+239,"dmem_req_reg", false,-1);
    ...
    tracep->declBit(c+241,"lsu_reg_wen", false,-1);
    tracep->declArray(c+242,"lsu_valid_data_reg", false,-1, 216,0);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+250+i*1,"regs", true,(i+0), 31,0);
    }
    tracep->popNamePrefix(1);
    ...
    tracep->declBit(c+282,"pre_valid_reg", false,-1);
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vrv32___024root__trace_full_sub_0(Vrv32___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+74,((1U & (vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[2U] 
                                  >> 0x15U))));
    bufp->fullIData(oldp+75,(((vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[2U] 
    ...
    bufp->fullBit(oldp+83,(vlSelf->rv32__DOT__w_wbu_cycle_end));
    bufp->fullBit(oldp+84,(vlSelf->rv32__DOT__w_wbu_npc_wen));
    bufp->fullBit(oldp+85,(((vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[1U] 
                             >> 0xfU) & (IData)(vlSelf->rv32__DOT__w_wbu_npc_wen))));
    bufp->fullIData(oldp+86,(vlSelf->rv32__DOT__bru_inst__DOT__npc_reg),32);
    bufp->fullIData(oldp+87,(vlSelf->rv32__DOT__w_rf_rs1),32);
    bufp->fullIData(oldp+88,(vlSelf->rv32__DOT__w_rf_rs2),32);
    bufp->fullIData(oldp+89,(vlSelf->rv32__DOT__w_cc_csr_src),32);
    bufp->fullIData(oldp+90,(((0x800000U & vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg[2U])
                               ...
                               : ((0x400000U & vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg[2U])
                                   ...
                                   : 0xdead005aU))),32);
    bufp->fullIData(oldp+91,(vlSelf->rv32__DOT__bru_inst__DOT__pc_jorb),32);
    bufp->fullIData(oldp+92,(vlSelf->rv32__DOT__bru_inst__DOT__npc_t1),32);
    bufp->fullIData(oldp+93,(vlSelf->rv32__DOT__bru_inst__DOT__npc_t2),32);
    ...
    __Vtemp_hbe37180e__0[2U] = ((((vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[6U] 
                                 ...
                                 + ((vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[5U] 
                                     << 7U) | (vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[4U] 
                                               >> 0x19U))) 
                                >> 0x1fU);
    bufp->fullWData(oldp+94,(__Vtemp_hbe37180e__0),66);
    bufp->fullQData(oldp+97,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+99,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+101,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+102,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+103,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+104,(vlSelf->rv32__DOT__bru_inst__DOT__mux1__DOT__i0__DOT__hit));
    bufp->fullBit(oldp+105,(vlSelf->rv32__DOT__bru_inst__DOT____Vcellinp__mux2____pinNumber2));
    ...
    __Vtemp_h094f6287__0[2U] = (((IData)(4U) + ((vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[5U] 
                                                ...
                                                | (vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg[4U] 
                                                   >> 0x19U))) 
                                >> 0x1fU);
    bufp->fullWData(oldp+106,(__Vtemp_h094f6287__0),66);
    bufp->fullQData(oldp+109,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+111,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+113,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+114,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+115,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+116,(vlSelf->rv32__DOT__bru_inst__DOT__mux2__DOT__i0__DOT__hit));
    ...
    __Vtemp_h2547afd7__0[2U] = (vlSelf->rv32__DOT__bru_inst__DOT__npc_t1 
                                >> 0x1fU);
    bufp->fullWData(oldp+117,(__Vtemp_h2547afd7__0),66);
    bufp->fullQData(oldp+120,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+122,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+124,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+125,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+126,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+127,(vlSelf->rv32__DOT__bru_inst__DOT__mux3__DOT__i0__DOT__hit));
    bufp->fullIData(oldp+128,(vlSelf->rv32__DOT__csr_ctrl_inst__DOT__mstatus),32);
    bufp->fullIData(oldp+129,(vlSelf->rv32__DOT__csr_ctrl_inst__DOT__mtvec),32);
    bufp->fullIData(oldp+130,(vlSelf->rv32__DOT__csr_ctrl_inst__DOT__mepc),32);
    bufp->fullIData(oldp+131,(vlSelf->rv32__DOT__csr_ctrl_inst__DOT__mcause),32);
    bufp->fullIData(oldp+132,(((0x1000000U & vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg[2U])
                                ? vlSelf->rv32__DOT__w_cc_csr_src
                                : vlSelf->rv32__DOT__exu_inst__DOT__exu_alu_res)),32);
    bufp->fullBit(oldp+133,((1U & ((vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg[0U] 
                                    >> 6U) & vlSelf->rv32__DOT__exu_inst__DOT__exu_alu_res))));
    bufp->fullIData(oldp+134,(vlSelf->rv32__DOT__exu_inst__DOT__exu_csr_rd),32);
    bufp->fullIData(oldp+135,(vlSelf->rv32__DOT__exu_inst__DOT__exu_alu_res),32);
    bufp->fullIData(oldp+136,(vlSelf->rv32__DOT__exu_inst__DOT__num1),32);
    bufp->fullIData(oldp+137,(vlSelf->rv32__DOT__exu_inst__DOT__num2),32);
    bufp->fullIData(oldp+138,(((IData)(1U) + (~ vlSelf->rv32__DOT__exu_inst__DOT__num2))),32);
    bufp->fullBit(oldp+139,(((~ (IData)(vlSelf->rv32__DOT__exu_inst__DOT__post_valid_reg)) 
                             & (IData)(vlSelf->rv32__DOT__idu_inst__DOT__post_valid_reg))));
    bufp->fullWData(oldp+140,(vlSelf->rv32__DOT__exu_inst__DOT__exu_valid_data_reg),253);
    ...
    __Vtemp_hce12de26__0[4U] = (vlSelf->rv32__DOT__w_rf_rs1 
                                >> 0x1aU);
    bufp->fullWData(oldp+148,(__Vtemp_hce12de26__0),136);
    bufp->fullQData(oldp+153,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+155,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+157,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+159,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+161,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+162,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+163,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+164,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+165,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+166,(vlSelf->rv32__DOT__exu_inst__DOT__mux1__DOT__i0__DOT__hit));
    ...
    __Vtemp_hd74c99fb__0[4U] = (vlSelf->rv32__DOT__w_rf_rs2 
                                >> 0x1aU);
    bufp->fullWData(oldp+167,(__Vtemp_hd74c99fb__0),136);
    bufp->fullQData(oldp+172,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+174,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+176,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+178,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+180,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+181,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+182,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+183,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+184,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+185,(vlSelf->rv32__DOT__exu_inst__DOT__mux2__DOT__i0__DOT__hit));
    ...
    bufp->fullWData(oldp+186,(__Vtemp_h00174f39__0),136);
    bufp->fullQData(oldp+191,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+193,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+195,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+197,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+199,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+200,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+201,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+202,(vlSelf->rv32__DOT__exu_inst__DOT__mux3__DOT__i0__DOT__data_list[3]),32);
    ...
    bufp->fullSData(oldp+207,((0xfffU & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                                 >> 0x14U)))),12);
    bufp->fullBit(oldp+208,(vlSelf->rv32__DOT__idu_inst__DOT__idu_csr_ren));
    bufp->fullBit(oldp+209,(vlSelf->rv32__DOT__idu_inst__DOT__idu_is_mret));
    bufp->fullBit(oldp+210,(vlSelf->rv32__DOT__idu_inst__DOT__idu_is_ecall));
    bufp->fullCData(oldp+211,(vlSelf->rv32__DOT__idu_inst__DOT__idu_csr_type),2);
    bufp->fullCData(oldp+212,(vlSelf->rv32__DOT__idu_inst__DOT__idu_alu_type),4);
    bufp->fullCData(oldp+213,(vlSelf->rv32__DOT__idu_inst__DOT__idu_num_sel),2);
    bufp->fullIData(oldp+214,(vlSelf->rv32__DOT__idu_inst__DOT__idu_imm),32);
    bufp->fullBit(oldp+215,((3U == (0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg)))));
    bufp->fullBit(oldp+216,((0x23U == (0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg)))));
    bufp->fullCData(oldp+217,((7U & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                             >> 0xcU)))),3);
    bufp->fullBit(oldp+218,((0x6fU == (0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg)))));
    bufp->fullBit(oldp+219,((0x67U == (0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg)))));
    bufp->fullBit(oldp+220,((0x63U == (0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg)))));
    bufp->fullCData(oldp+221,((0x1fU & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                                >> 7U)))),5);
    bufp->fullBit(oldp+222,(vlSelf->rv32__DOT__idu_inst__DOT__idu_gpr_wen));
    bufp->fullCData(oldp+223,((0x7fU & (IData)(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg))),7);
    bufp->fullCData(oldp+224,((0x1fU & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+225,((0x7fU & (IData)((vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg 
                                                >> 0x19U)))),7);
    bufp->fullBit(oldp+226,((1U & ((~ (IData)(vlSelf->rv32__DOT__idu_inst__DOT__post_valid_reg)) 
                                   & (~ (IData)(vlSelf->rv32__DOT__w_wbu_cycle_end))))));
    bufp->fullWData(oldp+227,(vlSelf->rv32__DOT__idu_inst__DOT__idu_valid_data_reg),111);
    bufp->fullIData(oldp+231,(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_inst),32);
    bufp->fullQData(oldp+232,(vlSelf->rv32__DOT__ifu_inst__DOT__ifu_valid_data_reg),64);
    bufp->fullBit(oldp+234,((IData)((0U != (0xc00000U 
                                            & vlSelf->rv32__DOT__exu_inst__DOT__exu_valid_data_reg[3U])))));
    bufp->fullIData(oldp+235,(((IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_req_reg)
                                ? ((4U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                    ? ((2U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                        ? 0U : ((1U 
                                                 & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                                 ? 
                                                (0xffffU 
                                                 & vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)
                                                 : 
                                                (0xffU 
                                                 & vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)))
                                    : ((2U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                        ? ((1U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                            ? 0U : vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)
                                        : ((1U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                            ? (((- (IData)(
                                                           (1U 
                                                            & (vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg 
                                ...
                                : ((vlSelf->rv32__DOT__exu_inst__DOT__exu_valid_data_reg[7U] 
                                    << 3U) | (vlSelf->rv32__DOT__exu_inst__DOT__exu_valid_data_reg[6U] 
                                              >> 0x1dU)))),32);
    bufp->fullIData(oldp+236,(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg),32);
    bufp->fullIData(oldp+237,(((4U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                ? ((2U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                    ? 0U : ((1U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                             ? (0xffffU 
                                                & vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)
                                             : (0xffU 
                                                & vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)))
                                : ((2U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                    ...
                                    : ((1U & (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg))
                                        ...
                                        : (((- (IData)(
                                            ...
                                            << 8U) 
                                           | (0xffU 
                                              & vlSelf->rv32__DOT__lsu_inst__DOT__dmem_rdata_t_reg)))))),32);
    bufp->fullCData(oldp+238,(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_func3_reg),3);
    bufp->fullBit(oldp+239,(vlSelf->rv32__DOT__lsu_inst__DOT__dmem_req_reg));
    bufp->fullCData(oldp+240,(vlSelf->rv32__DOT__lsu_inst__DOT__wmask),8);
    bufp->fullBit(oldp+241,(((~ (IData)(vlSelf->rv32__DOT__lsu_inst__DOT__post_valid_reg)) 
                             & (IData)(vlSelf->rv32__DOT__exu_inst__DOT__post_valid_reg))));
    bufp->fullWData(oldp+242,(vlSelf->rv32__DOT__lsu_inst__DOT__lsu_valid_data_reg),217);
    bufp->fullIData(oldp+249,(vlSelf->rv32__DOT__register_file_inst__DOT__i),32);
    bufp->fullIData(oldp+250,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[0]),32);
    bufp->fullIData(oldp+251,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[1]),32);
    bufp->fullIData(oldp+252,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[2]),32);
    bufp->fullIData(oldp+253,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[3]),32);
    bufp->fullIData(oldp+254,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[4]),32);
    bufp->fullIData(oldp+255,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[5]),32);
    bufp->fullIData(oldp+256,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[6]),32);
    bufp->fullIData(oldp+257,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[7]),32);
    bufp->fullIData(oldp+258,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[8]),32);
    bufp->fullIData(oldp+259,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[9]),32);
    bufp->fullIData(oldp+260,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[10]),32);
    bufp->fullIData(oldp+261,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[11]),32);
    bufp->fullIData(oldp+262,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[12]),32);
    bufp->fullIData(oldp+263,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[13]),32);
    bufp->fullIData(oldp+264,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[14]),32);
    bufp->fullIData(oldp+265,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[15]),32);
    bufp->fullIData(oldp+266,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[16]),32);
    bufp->fullIData(oldp+267,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[17]),32);
    bufp->fullIData(oldp+268,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[18]),32);
    bufp->fullIData(oldp+269,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[19]),32);
    bufp->fullIData(oldp+270,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[20]),32);
    bufp->fullIData(oldp+271,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[21]),32);
    bufp->fullIData(oldp+272,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[22]),32);
    bufp->fullIData(oldp+273,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[23]),32);
    bufp->fullIData(oldp+274,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[24]),32);
    bufp->fullIData(oldp+275,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[25]),32);
    bufp->fullIData(oldp+276,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[26]),32);
    bufp->fullIData(oldp+277,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[27]),32);
    bufp->fullIData(oldp+278,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[28]),32);
    bufp->fullIData(oldp+279,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[29]),32);
    bufp->fullIData(oldp+280,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[30]),32);
    bufp->fullIData(oldp+281,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[31]),32);
    bufp->fullBit(oldp+282,(vlSelf->rv32__DOT__wbu_inst__DOT__pre_valid_reg));
    bufp->fullBit(oldp+283,(vlSelf->clk));
    bufp->fullBit(oldp+284,(vlSelf->rst));
    bufp->fullIData(oldp+285,(0xfffffffeU),32);
    bufp->fullIData(oldp+286,(2U),32);
    bufp->fullIData(oldp+287,(1U),32);
    bufp->fullIData(oldp+288,(0x20U),32);
    bufp->fullIData(oldp+289,(0U),32);
    bufp->fullIData(oldp+290,(0U),32);
    bufp->fullIData(oldp+291,(0x21U),32);
    bufp->fullIData(oldp+292,(2U),32);
    bufp->fullIData(oldp+293,(4U),32);
    bufp->fullIData(oldp+294,(0x22U),32);
    bufp->fullIData(oldp+295,(4U),32);
}
