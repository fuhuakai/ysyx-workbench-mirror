...
VL_ATTR_COLD void Vrv32___024root__trace_init_sub__TOP__0(Vrv32___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+90,"mtvec_sync", false,-1, 31,0);
    tracep->declBus(c+91,"mepc_sync", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declArray(c+114,"lut", false,-1, 135,0);
    tracep->pushNamePrefix("i0 ");
    tracep->declBus(c+180,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+173,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+175,"DATA_LEN", false,-1, 31,0);
    ...
    tracep->declBus(c+181,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+119+i*2,"pair_list", true,(i+0), 33,0);
    }
    for (int i = 0; i < 4; ++i) {
    ...
    tracep->declBus(c+22,"Inst_type", false,-1, 2,0);
    tracep->declBus(c+41,"imm32", false,-1, 31,0);
    tracep->declBus(c+133,"imm_12", false,-1, 11,0);
    tracep->declBus(c+134,"imm_20", false,-1, 19,0);
    tracep->declBus(c+135,"imm_12_to_32", false,-1, 31,0);
    tracep->declBus(c+136,"imm_20_to_32", false,-1, 31,0);
    ...
    tracep->declBus(c+137,"rdata_temp", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    for (int i = 0; i < 32; ++i) {
        tracep->declBus(c+139+i*1,"regs", true,(i+0), 31,0);
    }
    tracep->popNamePrefix(2);
}
...
VL_ATTR_COLD void Vrv32___024root__trace_full_sub_0(Vrv32___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+90,(vlSelf->rv32__DOT__csr_regs_inst__DOT__mtvec_sync),32);
    bufp->fullIData(oldp+91,(vlSelf->rv32__DOT__csr_regs_inst__DOT__mepc_sync),32);
    ...
    __Vtemp_h3751e24b__0[2U] = (vlSelf->rv32__DOT__src2 
                                >> 0x1fU);
    bufp->fullWData(oldp+92,(__Vtemp_h3751e24b__0),66);
    bufp->fullQData(oldp+95,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+97,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+99,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+100,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+101,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+102,(vlSelf->rv32__DOT__i3__DOT__i0__DOT__hit));
    ...
    __Vtemp_h0807cf62__0[2U] = (vlSelf->rv32__DOT__pc 
                                >> 0x1fU);
    bufp->fullWData(oldp+103,(__Vtemp_h0807cf62__0),66);
    bufp->fullQData(oldp+106,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__pair_list[0]),33);
    bufp->fullQData(oldp+108,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__pair_list[1]),33);
    bufp->fullIData(oldp+110,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+111,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+112,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+113,(vlSelf->rv32__DOT__i4__DOT__i0__DOT__hit));
    ...
    __Vtemp_hb43057ff__0[4U] = (((IData)(4U) + vlSelf->rv32__DOT__pc) 
                                >> 0x1aU);
    bufp->fullWData(oldp+114,(__Vtemp_hb43057ff__0),136);
    bufp->fullQData(oldp+119,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__pair_list[0]),34);
    bufp->fullQData(oldp+121,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__pair_list[1]),34);
    bufp->fullQData(oldp+123,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__pair_list[2]),34);
    bufp->fullQData(oldp+125,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__pair_list[3]),34);
    bufp->fullIData(oldp+127,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__data_list[0]),32);
    bufp->fullIData(oldp+128,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__data_list[1]),32);
    bufp->fullIData(oldp+129,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__data_list[2]),32);
    bufp->fullIData(oldp+130,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__data_list[3]),32);
    bufp->fullIData(oldp+131,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__lut_out),32);
    bufp->fullBit(oldp+132,(vlSelf->rv32__DOT__i5__DOT__i0__DOT__hit));
    bufp->fullSData(oldp+133,(vlSelf->rv32__DOT__imm_extend_inst__DOT__imm_12),12);
    bufp->fullIData(oldp+134,(vlSelf->rv32__DOT__imm_extend_inst__DOT__imm_20),20);
    bufp->fullIData(oldp+135,(vlSelf->rv32__DOT__imm_extend_inst__DOT__imm_12_to_32),32);
    bufp->fullIData(oldp+136,(vlSelf->rv32__DOT__imm_extend_inst__DOT__imm_20_to_32),32);
    bufp->fullIData(oldp+137,(vlSelf->rv32__DOT__mem_inst__DOT__rdata_temp),32);
    bufp->fullIData(oldp+138,(vlSelf->rv32__DOT__register_file_inst__DOT__i),32);
    bufp->fullIData(oldp+139,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[0]),32);
    bufp->fullIData(oldp+140,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[1]),32);
    bufp->fullIData(oldp+141,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[2]),32);
    bufp->fullIData(oldp+142,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[3]),32);
    bufp->fullIData(oldp+143,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[4]),32);
    bufp->fullIData(oldp+144,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[5]),32);
    bufp->fullIData(oldp+145,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[6]),32);
    bufp->fullIData(oldp+146,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[7]),32);
    bufp->fullIData(oldp+147,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[8]),32);
    bufp->fullIData(oldp+148,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[9]),32);
    bufp->fullIData(oldp+149,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[10]),32);
    bufp->fullIData(oldp+150,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[11]),32);
    bufp->fullIData(oldp+151,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[12]),32);
    bufp->fullIData(oldp+152,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[13]),32);
    bufp->fullIData(oldp+153,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[14]),32);
    bufp->fullIData(oldp+154,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[15]),32);
    bufp->fullIData(oldp+155,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[16]),32);
    bufp->fullIData(oldp+156,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[17]),32);
    bufp->fullIData(oldp+157,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[18]),32);
    bufp->fullIData(oldp+158,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[19]),32);
    bufp->fullIData(oldp+159,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[20]),32);
    bufp->fullIData(oldp+160,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[21]),32);
    bufp->fullIData(oldp+161,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[22]),32);
    bufp->fullIData(oldp+162,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[23]),32);
    bufp->fullIData(oldp+163,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[24]),32);
    bufp->fullIData(oldp+164,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[25]),32);
    bufp->fullIData(oldp+165,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[26]),32);
    bufp->fullIData(oldp+166,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[27]),32);
    bufp->fullIData(oldp+167,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[28]),32);
    bufp->fullIData(oldp+168,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[29]),32);
    bufp->fullIData(oldp+169,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[30]),32);
    bufp->fullIData(oldp+170,(vlSelf->rv32__DOT__register_file_inst__DOT__regs[31]),32);
    ...
    bufp->fullIData(oldp+178,(0x21U),32);
    bufp->fullIData(oldp+179,(2U),32);
    bufp->fullIData(oldp+180,(4U),32);
    bufp->fullIData(oldp+181,(0x22U),32);
    bufp->fullIData(oldp+182,(4U),32);
    bufp->fullIData(oldp+183,(0xfffffffeU),32);
}
