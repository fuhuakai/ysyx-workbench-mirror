...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 010 ????? 11100 11", csrrs  , I, R(rd) = CSR(imm); CSR(imm) |= src1);//csrr和csrw都扩展为csrrs
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, mstatus_mret();s->dnpc = CSR(0x341) + 4);
